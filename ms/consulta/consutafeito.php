...
<head>
    ...
    <title>Historico de Consulta de Serviços</title>
...
<h1>Historico de serviços realizados</h1>
...
<table class='table'>
            ...
            if (!empty($filtro_responsavel)) {
                $consulta .= " where responsavel_servico LIKE '%$filtro_responsavel%'";
            }

            if (!empty($filtro_data)) {
                $consulta .= " where data_do_servico = '$filtro_data'";
            }

            if (!empty($filtro_local)) {
                $consulta .= " where local_do_servico LIKE '%$filtro_local%'";
            }

            if (!empty($filtro_status)) {
                $consulta .= " where status_do_servico = '$filtro_status'";
            }
            ...
            if ($resultado->num_rows > 0) {
             ...
             echo"       <tbody id='resultado-tabela'>";
                    ...
                    echo "<td>" . $linha["status_do_servico"] . "</td>";   if ($podeCadastrar){
                        echo "<td>";
                        echo "<br>.<a href='descricao_servico.php?id=" . $linha["id"] . "' class='btn btn-info'>Descrição</a>";
                        echo "</td>";
                    echo "<td>";
